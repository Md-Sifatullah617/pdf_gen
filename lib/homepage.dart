    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
              onPressed: () {
                _auth.signOut().then((value) => Navigator.push(context, MaterialPageRoute(builder: (context)=>const LoginPage()))).onError((error, stackTrace) => Utilities().toastMessage(error.toString(), color: Colors.red));
              },
